<?php
  ...
  mysqli_query($conn2, "INSERT INTO products(id_category, name_product, type, version, description, photo, price_netto, price_brutto, percent_vat, id_producents, founder)
  ...
  mysqli_query($conn2, "UPDATE clients SET founder='$name_product' WHERE id_client = '$id_user'");
